...
public class CommentService {
    ...
    public void save(CommentsDto commentsDto) {
        ...
        String message = mailContentBuilder.build(post.getUser().getUsername() + " adicionou um comentário em sua postagem." + POST_URL);
    ...
    public boolean containsSwearWords(String comment) {
        if (comment.contains("FDP")) {
            throw new SpringRedditException("Os comentários contêm linguagem inaceitável");
        }
        return false;
    }
}
